...
export default function HomePage() {
  ...
  return (
    ...
    >
      {/* Linke Seite: Sidebar, scrollt separat */}
      <div
        style={{
          width: "34%",
          padding: "1rem",
            ...
            >
              <button
                ...
                style={{
                  ...
                  borderRadius: "999px",
                  border:
                    activeCategory === "all" ? "none" : "1px solid #1f2937",
                  backgroundColor:
          ...
          {selectedLat !== null && selectedLng !== null && (
            ...
            >
              <Popup>
                ...
                <br />
                Vervollständige das Formular links und{" "}
                {editingPlaceId != null ? "aktualisiere den Ort." : "speichere."}
              </Popup>
            </Marker>
          )}
